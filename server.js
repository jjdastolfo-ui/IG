...
//
// CAMBIOS v2.2:
//   - Nueva categoria VP con conversion automatica USD/cabeza -> USD/kg
//   - Reestructuracion sub-indices (VI pasa a reposicion, VP es cria)
//   - Fix de fechas en scraper-pantalla
//   - Exclusion de registros sin volumen (salvo INAC)
//   - POST /api/precios protegido con secret admin
...
const FUENTES_SIN_VOLUMEN_OK = ['inac'];
...
app.get('/health', (req, res) => {
  res.json({ status: 'ok', service: 'IGU API', version: '2.2', timestamp: new Date().toISOString() });
});
...
app.listen(PORT, () => {
  console.log('='.repeat(60));
  console.log('IGU v2.2 - Indice Ganadero Uruguayo');
