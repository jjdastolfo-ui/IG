...
// ============================================================================
// Corre cada hora en el minuto 15 (para no chocar con el cron semanal).
// Si el healthcheck detecta estado 'warning' o 'critical', envia email via Resend.
// Si esta todo OK, no manda email (no spam).
...
app.listen(PORT, () => {
  console.log('='.repeat(60));
  console.log('IGU v2.3 - Indice Ganadero Uruguayo');
